...
class Emailer():
  #defining default attributes
    ...
    has_html = False
    test_send = False
    from_email = 'moodsync0 <moodsync0@gmail.com>'
    template_html = None
    template_name = None
    
    #init method changes default attributes / add some/ or render another class
